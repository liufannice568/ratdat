...
sig212=mean(sig212(2000:6000),2);
s212=min(sig212);
...
sig35=mean(signal35,2);
sig45=mean(signal45,2);
sig215=[sig15,sig25,sig35,sig45];
sig215=mean(sig215,2);
s215=min(sig215);
ss215=find(sig215==s215);

T=2
s21=[s211,s212,s213,s214,s215]
ss21=[ss211,ss212,ss213,ss214,ss215]
...
sig35=mean(signal35,2);
sig45=mean(signal45,2);
sig315=[sig15,sig25,sig35,sig45];
sig315=mean(sig315,2);
s315=min(sig315);
ss315=find(sig315==s315);

T=3
s31=[s311,s312,s313,s314,s315]
ss31=[ss311,ss312,ss313,ss314,ss315]
...
sig35=mean(signal35,2);
sig45=mean(signal45,2);
sig415=[sig15,sig25,sig35,sig45];
sig415=mean(sig415,2);
s415=min(sig415);
ss415=find(sig415==s415);


T=4
s41=[s411,s412,s413,s414,s415]
ss41=[ss411,ss412,ss413,ss414,ss415]
...
sig35=mean(signal35,2);
sig45=mean(signal45,2);
sig515=[sig15,sig25,sig35,sig45];
sig515=mean(sig515,2);
s515=min(sig515);
ss515=find(sig515==s515);


T=5
s51=[s511,s512,s513,s514,s515]
ss51=[ss511,ss512,ss513,ss514,ss515]
...
sig35=mean(signal35,2);
sig45=mean(signal45,2);
sig615=[sig15,sig25,sig35,sig45];
sig615=mean(sig615,2);
s615=min(sig615);
ss615=find(sig615==s615);

T=6
s61=[s611,s612,s613,s614,s615]
ss61=[ss611,ss612,ss613,ss614,ss615]
...
sig35=mean(signal35,2);
sig45=mean(signal45,2);
sig715=[sig15,sig25,sig35,sig45];
sig715=mean(sig715,2);
s715=min(sig715);
ss715=find(sig715==s715);
T=7
s71=[s711,s712,s713,s714,s715]
ss71=[ss711,ss712,ss713,ss714,ss715]
...
sig35=mean(signal35,2);
sig45=mean(signal45,2);
sig815=[sig15,sig25,sig35,sig45];
sig815=mean(sig815,2);
s815=min(sig815);
ss815=find(sig815==s815);
T=8
s81=[s811,s812,s813,s814,s815]
ss81=[ss811,ss812,ss813,ss814,ss815]
